  ...
  return (
    <section className="relative py-20 sm:py-28 px-6">
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-2 text-gray-900">
            A repeatable system.
          </h2>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4 text-gray-400">
            Not ad hoc content.
          </h2>
          <p className="text-base text-gray-500 font-body mb-10 max-w-xl leading-relaxed">
        ...
        <div className="space-y-3">
          {items.map((item, i) => (
            <motion.div
              key={i}
              className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-gray-50/80 hover:border-emerald-300 transition-colors"
            ...
            >
              ...
              <p className="text-sm text-gray-800 font-body font-medium">{item.text}</p>
            </motion.div>
          ))}
        </div>
      </div>
