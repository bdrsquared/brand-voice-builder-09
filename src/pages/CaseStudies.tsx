...
const caseStudies = [
  {
    ...
    logo: "Polly",
    description: "How Polly used podcasting to make life insurance feel human and accessible, generating strong early leads.",
    stats: "Strong engagement · Leads exceeded target",
  ...
  },
  {
    ...
    logo: "Soldo",
    description: "How Soldo turned podcasting into meaningful qualified pipeline and positioned as a thought leader with CFOs.",
    stats: "Strong downloads · Significant ROI",
  ...
  },
  {
    ...
    logo: "IG",
    description: "How IG cut through market noise with a weekly podcast that delivered strong audience growth and high consumption.",
  ...
  },
  {
    ...
    stats: "Strong views · High consumption",
    image: casePulsetto,
    slug: "no-stress",
  },
  {
