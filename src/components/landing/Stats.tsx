    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `radial-gradient(400px circle at ${pos.x}px ${pos.y}px, #221C43 / 0.5, transparent 60%)`,
        }}
      />
      {/* Border glow overlay */}
      <div
        ...
        style={{
          opacity: hovering ? 1 : 0,
          background: `radial-gradient(300px circle at ${pos.x}px ${pos.y}px, #221C43, transparent 60%)`,
