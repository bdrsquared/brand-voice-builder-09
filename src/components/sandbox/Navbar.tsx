  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className={`${navLight ? "bg-white/70 border-black/10 shadow-black/5" : "bg-white/5 border-white/10 shadow-black/20"} backdrop-blur-xl border rounded-full pl-3 sm:pl-6 pr-3 sm:pr-1.5 flex items-center justify-between h-14 shadow-lg transition-colors duration-300`}>
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <button
                ...
                className={`group relative inline-flex items-center gap-2 text-sm font-semibold px-5 h-11 rounded-full transition-all backdrop-blur-xl overflow-hidden cursor-pointer ${
                  navLight
